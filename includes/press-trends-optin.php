...
function presstrends_top_text() {
	$po_logo = BM_BASE_URL . 'includes/images/logo.png';

    echo '<p style="width:190px;float:left;"><img src=' . "$po_logo" . '></p><p style="width:500px;float:left;color:#777;padding-top:2px;"><b>PressTrends</b> helps theme authors build better themes and provide awesome support by retrieving aggregated stats. PressTrends also provides a <a href="http://wordpress.org/extend/plugins/presstrends/" title="PressTrends Plugin for WordPress" target="_blank">plugin</a> that delivers stats on how your site is performing against the web and similar sites like yours. <a href="http://www.presstrends.me" title="PressTrends" target="_blank">Learn more…</a></p>';
}
...
$api_key = 'qe1gpij29zvpcgle03vfzoghf947ro1i6hfa';
